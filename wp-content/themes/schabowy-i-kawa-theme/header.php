...
<body <?php body_class(); ?>>
  <header class="site-header">
    <div class="container">
      ...
      <a href="<?php esc_url(site_url('/wyszukaj')) ?>" class="js-search-trigger site-header__search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          ...
          <a href="<?php esc_url(site_url('/wyszukaj')) ?>" class="search-trigger js-search-trigger push-right"><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i></a>
        </div>
      </div>
    </div>
  </header>